@echo off
rem ============================================================
rem multi-agent backend quick restart (Windows cmd wrapper, ASCII only)
rem Executes scripts/dev-restart.sh via Git Bash (bundled with Git for Windows)
rem Usage: scripts\dev-restart.bat   (works from any directory)
rem ============================================================
...
"%GIT_BASH%" scripts/dev-restart.sh
exit /b %errorlevel%

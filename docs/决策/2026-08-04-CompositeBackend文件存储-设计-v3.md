...
>
> **关联文档**：
> - 深化改造评审稿：`docs/决策/2026-08-05-设计-CompositeBackend深化改造-v1.md`（§6 完整代码 / §7 验收测试 / §8 优先级）
> - 持久化计划：`docs/决策/2026-08-04-持久化能力开发计划-Checkpointer与Store-v1.md`（§B.0 / §B.1 / §B.2）

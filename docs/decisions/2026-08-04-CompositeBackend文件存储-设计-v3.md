...
>
> **关联文档**：
> - 深化改造评审稿：`docs/decisions/2026-08-05-设计-CompositeBackend深化改造-v1.md`（§6 完整代码 / §7 验收测试 / §8 优先级）
> - 持久化计划：`docs/decisions/2026-08-04-持久化能力开发计划-Checkpointer与Store-v1.md`（§B.0 / §B.1 / §B.2）
> - 架构：`docs/架构/2026-08-02-多agent项目-架构目录-v1.md`（§2 目录树 / §2.1 能力落地位置对照）

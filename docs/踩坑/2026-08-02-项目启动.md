...
> | 版本 | 日期 | 具体改动（精确到二级标题） |
> |------|------|------|
> | v2 | 2026-08-02 | §背景 蓝图引用路径更新为 `docs/架构/2026-08-02-多agent项目-架构目录-v1.md`；版本记录按新规范改为文档头永久保存 |
...
## 背景
从零搭建多 Agent 学习项目（multi_agent）。蓝图来自 `docs/架构/2026-08-02-多agent项目-架构目录-v1.md`（v2.2 → v2.3）。
